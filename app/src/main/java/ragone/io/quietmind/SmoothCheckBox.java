...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private static final int COLOR_FLOOR_UNCHECKED = Color.WHITE;
    ...
    private void init(AttributeSet attrs) {
        ...
        mText = ta.getString(R.styleable.SmoothCheckBox_text);
...
//                CompatUtils.dp2px(getContext(), 0));
        mStrokeWidth = CompatUtils.dp2px(getContext(), 1);
        ta.recycle();
    ...
    private void drawTick(Canvas canvas) {
        if (mTickDrawing && isChecked()) {
            ...
            canvas.drawText(text, mCenterPoint.x, mCenterPoint.y + rect.height() / 2, p);
        }
    }
